...
const SignUp = () => {
  return (
    <div className="flex flex-col items-center justify-start shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(34,42,53,0.04),0_24px_68px_rgba(47,48,55,0.05),0_2px_3px_rgba(0,0,0,0.04)] w-[30%] bg-white rounded-2xl p-10 gap-3">
            ...
            <span className="text-xl text-neutral-500"> Sign up for ProtonX </span>
            {/* INPUT FIELDS */}
            ...
            <IconButton icon={GoogleIcon} className="w-full" text="Sign up with Google" />
            <IconButton icon={GitHubIcon} className="w-full" text="Sign up with GitHub" />
            <IconButton icon={LinkedInIcon} className="w-full" text="Sign up with LinkedIn" />

            <Link href="/temp1/login" className="text-neutral-600 text-xs"> Click here to Sign In </Link>
